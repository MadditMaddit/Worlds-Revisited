if (formatted == 0)
{
        ...
        else if (thischar == "\\")
        {
            ...
            if (dialoguer == 1)
            {
                ...
                if (nextchar == "O")
                {
                    ...
                    if (global.writerobj[nextchar2var] == 1531)
    ...
    if (autocenter == 1)
    {
        x = ((camerax() + (__view_get(e__VW.WView, 0) / 2)) - ((stringmax * hspace) / 2)) + 5;
        y = (cameray() + (__view_get(e__VW.HView, 0) / 2)) - ((writingy + ((linecount + 1) * vspace)) / 2) - 10;
    }
