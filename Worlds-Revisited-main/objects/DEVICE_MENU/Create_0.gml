...
if (ossafe_file_exists("dr.ini"))
{
    ...
    for (i = 0; i < 3; i++)
    {
        COMPLETEFILE_PREV_NAME[i] = "NO DATA";
        COMPLETEFILE_PREV_TIME[i] = 0;
        COMPLETEFILE_PREV_PLACE[i] = "CHAPTER 1";
        INCOMPLETEFILE_PREV_NAME[i] = "NO DATA";
        ...
        if (loadcompletion)
        {
            COMPLETEFILE_PREV_NAME[i] = "UNKNOWN FILE";
        ...
        {
            INCOMPLETEFILE_PREV_NAME[i] = "UNKNOWN FILE";
